...
[task_local]
#金榜年终奖
10 0 * * * https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_split.js, cronexpr="10 0 * * *", timeout=200, enable=true
 */
const $ = new Env('金榜年终奖');
...
$.newShareCodes = ['P04z54XCjVUnIaW5uyjkrZ8eqXpJPi_Og', 'P04z54XCjVUnIaW5m9cZ2St3H0bldaNml_70cE', 'P04z54XCjVUnIaW5m9cZ2Wu3C8fxyPxwu4694o-rnMYj', 'P04z54XCjVUnIaW5m9cZ2es1S4ZxK3a8Wi5eAA'];
!(async () => {
  if (!cookiesArr[0]) {
