...
const inviteCodes = [
  `ATGEC3-fsqiM@AUWE5H0elA@ATGEC3-fiaM@AUWE2mr1XhJlQ@AUWE5m_zKr3nwfkg@A06fE2InZA@AUWE5dkA`,
  `ATGEC3-fEqiM@AUWE5ma0elA@ATGEC3-faEqiM@AUWUmDdZXhJlQ@AUWm_jEZnwfkg@A06fNS2InZA@AUW6_Bm`
]
!(async () => {
  $.tuanList = []
  await requireConfig();
