...
[task_local]
#健康抽奖机
10 0 * * * https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_health.js, tag=健康抽奖机, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_health.js,tag=健康抽奖机

===============Surge=================
健康抽奖机 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_health.js

============小火箭=========
健康抽奖机 = type=cron,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_health.js, cronexpr="10 0 * * *", timeout=200, enable=true
 */
const $ = new Env('健康抽奖机');
...
const inviteCodes = [`P04z54XCjVUnoaW5m9cZ2ariXVJwFN5uKHNqnc`, 'P04z54XCjVUnoaW5m9cZ2Wu3C8fx8skjuZicLg', `P04z54XCjVUnoaW5m9cZ2St3H0blUr0LDdkUa0`, `P04z54XCjVUnoaW5uyjkrZ8eqXpJEZ0tQ`];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
