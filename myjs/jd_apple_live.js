...
[task_local]
#苹果抽奖机
10 0 * * * https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_apple_live.js, tag=苹果抽奖机, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_apple_live.js,tag=苹果抽奖机

===============Surge=================
苹果抽奖机 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_apple_live.js

============小火箭=========
苹果抽奖机 = type=cron,script-path=https://raw.githubusercontent.com/Andecy/jd_02/main/myjs/jd_apple_live.js, cronexpr="10 0 * * *", timeout=200, enable=true
 */
const $ = new Env('苹果抽奖机');
...
const inviteCodes = ['P04z54XCjVUm4aW5m9cZ2St3H0blZ3YU-cEWls@P04z54XCjVUm4aW5m9cZ2Wu3C8fx3PhPZ1chCA@P04z54XCjVUm4aW5m9cZ2es1S4ZxMu5wsH7IPc','P04z54XCjVUm4aW5uyjkrZ8eqXpJKc8Lw@P04z54XCjVUm4aW5m9cZ2Wu3C8fx3PhPZ1chCA@P04z54XCjVUm4aW5m9cZ2es1S4ZxMu5wsH7IPc','P04z54XCjVUm4aW5uyjkrZ8eqXpJKc8Lw@P04z54XCjVUm4aW5m9cZ2St3H0blZ3YU-cEWls@P04z54XCjVUm4aW5m9cZ2es1S4ZxMu5wsH7IPc','P04z54XCjVUm4aW5uyjkrZ8eqXpJKc8Lw@P04z54XCjVUm4aW5m9cZ2St3H0blZ3YU-cEWls@P04z54XCjVUm4aW5m9cZ2Wu3C8fx3PhPZ1chCA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
